...
3. **DONE** — `srp-analytic`: cannonball, flat plate, box-wing. Sources: Fliegel & Gallini;
   ...
   *Recorded 2026-09-23:* this step closed the SRP force **law** — cannonball, flat plate, box-wing —
   and no step composed it with step 1's shadow function, the Sun's position and distance, and
   attitude into a `dyn::Force`. That composition was never assigned; it moves to step 5, where
   the law's irradiance also becomes a parameter so the Sun's ±3.4 % annual variation can be
   represented at all.
