...
void    days2mdhms
        ...
        )
   {
     ...
     dayofyr = static_cast<int>(floor(days));
     ...
     hr   = static_cast<int>(floor(temp));
     temp = (temp - hr) * 60.0;
     minute  = static_cast<int>(floor(temp));
...
void    invjday
        ...
        )
   {
     ...
     temp    = jd - 2415019.5;
     tu      = temp / 365.25;
     year    = 1900 + static_cast<int>(floor(tu));
     leapyrs = static_cast<int>(floor((year - 1901) * 0.25));
