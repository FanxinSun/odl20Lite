     ...
     )
{
     const double twopi = 2.0 * M_PI;
     int iretn;
     double delt, ft, theta, x2li, x2omi, xl, xomi, g22, g32, g44, g52, g54,
            fasx2, fasx4, fasx6, rptim , step2, stepn, stepp;
     double xldot = 0.0, xnddt = 0.0, xndt = 0.0;
     ...
     )
{
     ...
     initl
         (
           whichconst, satrec.ecco, epoch, satrec.inclo, satrec.no, satrec.method,
         ...
         if ((2*M_PI / satrec.no) >= 225.0)
           {
             ...
             dpper
                 (
                   ...
                   satrec.xgh2,satrec.xgh3,satrec.xgh4, satrec.xh2,
                   satrec.xh3, satrec.xi2, satrec.xi3,  satrec.xl2,
                   satrec.xl3, satrec.xl4, satrec.zmol, satrec.zmos, satrec.init,
