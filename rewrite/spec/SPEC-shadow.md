...
- **SHDW-R-031.** **99.9 % of it cancels across ONE STATED PASSAGE, and the figure is stated
  ...
  **circular** orbit with the shadow axis lying in the orbital plane (β = 0°), one side of the
  ...
  rate** — so the net time integral is a few × 10⁻⁴ s of equivalent full sunlight against an
  ...
  `net` or the swing ratio, is this row's stable number. A consumer integrating whole passages
  barely sees it;
