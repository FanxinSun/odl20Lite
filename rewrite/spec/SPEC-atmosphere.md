...
- **ATMO-P-1.** Relative difference *r* = |*x*ₛ − *x*_d| / |*x*_d| between the single-precision
  ...
  **loosen** it. A bound a wider sweep keeps moving is not yet a bound the sweep has finished
